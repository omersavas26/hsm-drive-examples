...
public class JavaExample 
{
    public static void main(String[] args) throws Exception {
        // Path to the PKCS#11 provider library (DLL)
        String pkcs11Config = "name=YourHSM\nlibrary=/path/to/your/PKCS11Library.dll";
        
        // Load the PKCS#11 provider
        Provider pkcs11Provider = new sun.security.pkcs11.SunPKCS11(new java.io.ByteArrayInputStream(pkcs11Config.getBytes()));
        Security.addProvider(pkcs11Provider);
        
        // Initialize the key store
        KeyStore keyStore = KeyStore.getInstance("PKCS11");
        char[] pin = "yourPin".toCharArray(); // Pin for the PKCS#11 device
...
//     {
//         final String keyName = "aes128";
//         final String library = "C:\\SoftHSM2\\lib\\softhsm2-x64.dll";

//         final String slot = "577229486";
//         final char[] pin = {'9', '9', '9', '9'};

//         StringBuilder builder = new StringBuilder();
//         builder.append("name=" + keyName);
...
//         System.out.println(gonderilenCumle);
